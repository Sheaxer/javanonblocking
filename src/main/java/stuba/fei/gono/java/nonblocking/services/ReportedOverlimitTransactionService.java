...
public interface ReportedOverlimitTransactionService {
     ...
     Mono<ReportedOverlimitTransaction> postTransaction(ReportedOverlimitTransaction transaction) throws ReportedOverlimitTransactionValidationException;
     ...
     Mono<Void> deleteTransaction (String id) throws ReportedOverlimitTransactionException;
